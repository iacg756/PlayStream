...
namespace PlayStream.Api.Filters
{
    public class ExceptionHandlingMiddleware
    {
        ...
        private static Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            ...
            var response = new ErrorResponse { Status = (int)code, Title = code.ToString(), Message = message, Errors = errors, TraceId = context.TraceIdentifier };
